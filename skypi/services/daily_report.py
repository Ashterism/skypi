...
def tonight_at_a_glance(hourlyweather, hourlymoon):
    ...
    # moon elements
    for hr in hourlymoon:
        all_moon.append(hr.el)

    moon_phase = get_moon_phase(hourlymoon[0].phase)
    moon_start_alt = hourlymoon[0].el
    moon_end_alt = hourlymoon[-1].el
...
def get_daily_report():
    ...
    go_no_go, hours = get_evaluations(hourlyweather, hourlymoon)
    at_a_glance = tonight_at_a_glance(hourlyweather, hourlymoon)
